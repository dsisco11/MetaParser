    ...
    public sealed partial class Parser
    {
        private static bool TryProcessCompound(global::System.ReadOnlySpan<byte> input, out byte id, out int length)
        {
            ...
            bool consume_pattern_27(global::System.ReadOnlySpan<byte> input, out int length)
            {
                ...
                * TokenID: comment (#22)
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 22, Name = comment, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 22, ConsumerIndex = -1 } }, Index = 27, Type = Token, Identity = TokenGraphId { TokenIndex = 22, ConsumerIndex = 27 }, DependencyInfo = ResolvedVertexNode { Order = 48, MinDepth = 1, MaxDepth = 2, IsRecursive = True }, Start = PatternGroup { Length = 2, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 2 }, Consume = , Stop = PatternGroup { Length = 1, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 1 }, Escape = , IsOpen = False, IsClosed = True, IsDynamic = True, IsConstant = False }
                */
            ...
            bool consume_pattern_28(global::System.ReadOnlySpan<byte> input, out int length)
            {
                ...
                * TokenID: comment (#22)
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 22, Name = comment, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 22, ConsumerIndex = -1 } }, Index = 28, Type = Token, Identity = TokenGraphId { TokenIndex = 22, ConsumerIndex = 28 }, DependencyInfo = ResolvedVertexNode { Order = 48, MinDepth = 1, MaxDepth = 2, IsRecursive = True }, Start = PatternGroup { Length = 2, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 2 }, Consume = , Stop = PatternGroup { Length = 2, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 2 }, Escape = PatternGroup { Length = 1, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 1 }, IsOpen = False, IsClosed = True, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
                var buffer = input.Slice(2);
                while (buffer.Length > 0)
            ...
            bool consume_pattern_29(global::System.ReadOnlySpan<byte> input, out int length)
            {
                ...
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 23, Name = codeblock, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 23, ConsumerIndex = -1 } }, Index = 29, Type = Token, Identity = TokenGraphId { TokenIndex = 23, ConsumerIndex = 29 }, DependencyInfo = ResolvedVertexNode { Order = 48, MinDepth = 1, MaxDepth = 2, IsRecursive = True }, Start = PatternGroup { Length = 1, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 1 }, Consume = , Stop = PatternGroup { Length = 1, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 1 }, Escape = , IsOpen = False, IsClosed = True, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
