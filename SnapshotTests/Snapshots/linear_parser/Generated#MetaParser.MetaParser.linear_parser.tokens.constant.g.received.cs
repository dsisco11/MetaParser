    ...
    public sealed partial class Parser
    {
        private static bool TryProcessConstant(global::System.ReadOnlySpan<char> input, out byte id, out int length)
        {
            ...
            bool consume_pattern_16(global::System.ReadOnlySpan<char> input, out int length)
            {
                ...
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 16, Name = whitespace, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 16, ConsumerIndex = -1 } }, Index = 16, Type = Data, Identity = TokenGraphId { TokenIndex = 16, ConsumerIndex = 16 }, DependencyInfo = ResolvedVertexNode { Order = 10, MinDepth = 0, MaxDepth = 0, IsRecursive = False }, Start = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Consume = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Stop = , Escape = , IsOpen = True, IsClosed = False, IsDynamic = True, IsConstant = False }
                */
            ...
            bool consume_pattern_17(global::System.ReadOnlySpan<char> input, out int length)
            {
                ...
                * TokenID: digits (#17)
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 17, Name = digits, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 17, ConsumerIndex = -1 } }, Index = 17, Type = Data, Identity = TokenGraphId { TokenIndex = 17, ConsumerIndex = 17 }, DependencyInfo = ResolvedVertexNode { Order = 36, MinDepth = 0, MaxDepth = 0, IsRecursive = False }, Start = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Consume = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Stop = , Escape = , IsOpen = True, IsClosed = False, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
                var buffer = input.Slice(1);
            ...
            bool consume_pattern_18(global::System.ReadOnlySpan<char> input, out int length)
            {
                ...
                * TokenID: letters (#18)
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 18, Name = letters, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 18, ConsumerIndex = -1 } }, Index = 18, Type = Data, Identity = TokenGraphId { TokenIndex = 18, ConsumerIndex = 18 }, DependencyInfo = ResolvedVertexNode { Order = 20, MinDepth = 0, MaxDepth = 0, IsRecursive = False }, Start = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Consume = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Stop = , Escape = , IsOpen = True, IsClosed = False, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
                var buffer = input.Slice(1);
            ...
            bool consume_pattern_19(global::System.ReadOnlySpan<char> input, out int length)
            {
                ...
                * TokenID: newline (#19)
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 19, Name = newline, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 19, ConsumerIndex = -1 } }, Index = 19, Type = Data, Identity = TokenGraphId { TokenIndex = 19, ConsumerIndex = 19 }, DependencyInfo = ResolvedVertexNode { Order = 6, MinDepth = 0, MaxDepth = 0, IsRecursive = False }, Start = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Consume = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Stop = , Escape = , IsOpen = True, IsClosed = False, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
                var buffer = input.Slice(1);
            ...
            bool consume_pattern_20(global::System.ReadOnlySpan<char> input, out int length)
            {
                ...
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 20, Name = identifier, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 20, ConsumerIndex = -1 } }, Index = 20, Type = Data, Identity = TokenGraphId { TokenIndex = 20, ConsumerIndex = 20 }, DependencyInfo = ResolvedVertexNode { Order = 32, MinDepth = 0, MaxDepth = 0, IsRecursive = False }, Start = PatternGroup { Length = 2, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 2 }, Consume = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Stop = , Escape = , IsOpen = True, IsClosed = False, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
            ...
            bool consume_pattern_26(global::System.ReadOnlySpan<char> input, out int length)
            {
                ...
                * TokenID: comment (#22)
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 22, Name = comment, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 22, ConsumerIndex = -1 } }, Index = 26, Type = Data, Identity = TokenGraphId { TokenIndex = 22, ConsumerIndex = 26 }, DependencyInfo = ResolvedVertexNode { Order = 2, MinDepth = 0, MaxDepth = 0, IsRecursive = False }, Start = PatternGroup { Length = 2, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 2 }, Consume = , Stop = PatternGroup { Length = 2, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 2 }, Escape = PatternGroup { Length = 1, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 1 }, IsOpen = False, IsClosed = True, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
                var buffer = input.Slice(2);
                while (buffer.Length > 0)
