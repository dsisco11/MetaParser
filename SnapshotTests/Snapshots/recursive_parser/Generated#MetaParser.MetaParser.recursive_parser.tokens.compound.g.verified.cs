    ...
    public sealed partial class Parser
    {
        private static bool TryProcessCompound(global::System.ReadOnlySpan<byte> input, out byte id, out int length)
        {
            ...
            bool consume_pattern_15(global::System.ReadOnlySpan<byte> input, out int length)
            {
                ...
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 14, Name = declaration, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 14, ConsumerIndex = -1, Type = Token } }, Index = 15, Type = Token, Identity = TokenGraphId { TokenIndex = 14, ConsumerIndex = 15, Type = Token }, DependencyInfo = ResolvedVertexNode { Order = 26, MinDepth = 1, MaxDepth = 1, IsRecursive = True }, Start = PatternGroup { Length = 2, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 2 }, Consume = , Stop = PatternGroup { Length = 1, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 1 }, Escape = , IsOpen = False, IsClosed = True, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
                var buffer = input.Slice(2);
                while (buffer.Length > 0)
            ...
            bool consume_pattern_16(global::System.ReadOnlySpan<byte> input, out int length)
            {
                ...
                * ==[ CONSUMER_DATA ]==
                * TokenConsumer { Token = TokenInfo { Index = 15, Name = codeblock, Consumers = System.Collections.Generic.List`1[MetaParser.Consumers.TokenConsumer], Identity = TokenGraphId { TokenIndex = 15, ConsumerIndex = -1, Type = Token } }, Index = 16, Type = Token, Identity = TokenGraphId { TokenIndex = 15, ConsumerIndex = 16, Type = Token }, DependencyInfo = ResolvedVertexNode { Order = 26, MinDepth = 1, MaxDepth = 1, IsRecursive = True }, Start = PatternGroup { Length = 1, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 1 }, Consume = PatternGroup { Length = 1, IsRawValues = False, IsConstantLength = True, HasChildren = True, Condition = OneOf, ConditionJoiner =  or , MinLength = 1 }, Stop = PatternGroup { Length = 1, IsRawValues = True, IsConstantLength = True, HasChildren = True, Condition = AllOf, ConditionJoiner = , , MinLength = 1 }, Escape = , IsOpen = False, IsClosed = True, IsDynamic = True, IsConstant = False }
                */
                /* Consume the START sequence which got us here in the first place, we already know its part of the token */
