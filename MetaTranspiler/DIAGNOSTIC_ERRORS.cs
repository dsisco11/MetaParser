...
{
    internal static class DIAGNOSTIC_ERRORS
    {
        public static DiagnosticDescriptor DebugInfo => new DiagnosticDescriptor("MP000", "MetaTranspiler", "{0}", "Compiler", DiagnosticSeverity.Info, true);
        public static DiagnosticDescriptor SchemaException => new DiagnosticDescriptor("MP001", "Schema Error", "[{0}] {1}", "Compiler", DiagnosticSeverity.Error, true);
