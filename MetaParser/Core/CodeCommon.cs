...
";
    ...
    #region Formatting
    public static string Format_Pattern_Start_Detection_Function_Name(int consumerIndex) => $"is_start_of_consumer_{consumerIndex}";
