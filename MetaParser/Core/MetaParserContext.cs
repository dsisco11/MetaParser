...
namespace MetaParser.Core
{
    internal record MetaParserContext : ICodeBuilderContext
    {
        ...
        #region Builders
        public TypeSyntax Get_Consumer_Data_Type(EConsumerType type) => (type == EConsumerType.Data? Config.InputType : Config.IdType);
